...
var base_url = (window.location != window.parent.location)
            ? document.referrer
...
if (base_url.indexOf('?') > -1) {
	...
	var base_url = window.location.href.split('%7C').pop();
	console.log(base_url)

	var URLqueryString = location.search.substring(1);
	console.log(URLqueryString)

	var URLstring_split = URLqueryString.split("%7C");
...
$(document).ready(function(){
   ...
   // end county data response
			...
			if (which_gobutton == "county") {
				...
				$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/fire_county_chart.csv', function(csvString) {
				    ...
				    filtered_data = data.filter(function(obj) {
		          	...
		          	if (filtered_data.length == 0) {
		          		$(".fire-map-link").attr("href", "index.html#begin").find(".concern-title")
		          		$(".wildfire-risk-major").html('NA')
			          	$(".of-properties-fire-major").html('No data available for')
			          	$(".wildfire-risk-severe").html('NA')
			          	$(".of-properties-fire-severe").html('No data available for')
		          	} else {

		          		$(".fire-map-link").attr("href", "risk-maps.html?county%7Cfire%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+base_url)
				...
				$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/heat_county_chart.csv', function(csvString) {
				    ...
				    filtered_data = data.filter(function(obj) {
		          	...
		          	if (filtered_data.length == 0) {
		          		$(".heat-map-link").attr("href", "index.html#begin").find(".concern-title")
		          		$(".heat-risk-major").html('NA')
			          	$(".of-properties-heat-major").html('No data available for')
			          	$(".heat-risk-severe").html('NA')
			          	$(".of-properties-heat-severe").html('No data available for')
		          	} else {

		          		$(".heat-map-link").attr("href", "risk-maps.html?county%7Cheat%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+base_url)
				...
				$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/flood_county_chart.csv', function(csvString) {
				    ...
				    filtered_data = data.filter(function(obj) {
		          	...
		          	if (filtered_data.length == 0) {
		          		$(".flood-map-link").attr("href", "index.html#begin").find(".concern-title")
		          		$(".flood-risk-major").html('NA')
			          	$(".of-properties-flood-major").html('No data available for')
			          	$(".flood-risk-severe").html('NA')
			          	$(".of-properties-flood-severe").html('No data available for')
		          	} else {

		          		$(".flood-map-link").attr("href", "risk-maps.html?county%7Cflood%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+base_url)
				...
				$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/wind_county_chart.csv', function(csvString) {
				    ...
				    filtered_data = data.filter(function(obj) {
		          	...
		          	if (filtered_data.length == 0) {
		          		$(".wind-map-link").attr("href", "index.html#begin").find(".concern-title")
		          		$(".wind-risk-major").html('NA')
			          	$(".of-properties-wind-major").html('No data available for')
			          	$(".wind-risk-severe").html('NA')
			          	$(".of-properties-wind-severe").html('No data available for')
		          	} else {
			          	...
			          	$(".wind-map-link").attr("href", "risk-maps.html?county%7Cwind%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+base_url)
	...
	$("#state_zoombutton").click(function(){
		...
		$(".fire-map-link").attr("href", "")
		$(".heat-map-link").attr("href", "")
		$(".flood-map-link").attr("href", "")
		$(".wind-map-link").attr("href", "")
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/fire_state_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
          		...
          		$(".fire-map-link").attr("href", "risk-maps.html?state%7Cfire%7C"+picked_state_fips+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/heat_state_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
          		...
          		$(".heat-map-link").attr("href", "risk-maps.html?state%7Cheat%7C"+picked_state_fips+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/flood_state_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
	          	...
	          	$(".flood-map-link").attr("href", "risk-maps.html?state%7Cflood%7C"+picked_state_fips+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/wind_state_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
	          	...
	          	$(".wind-map-link").attr("href", "risk-maps.html?state%7Cwind%7C"+picked_state_fips+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/fire_zip_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
          		...
          		$(".fire-map-link").attr("href", "risk-maps.html?zip%7Cfire%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+picked_zip+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/heat_zip_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
          		...
          		$(".heat-map-link").attr("href", "risk-maps.html?zip%7Cheat%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+picked_zip+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/flood_zip_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
          		...
          		$(".flood-map-link").attr("href", "risk-maps.html?zip%7Cflood%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+picked_zip+"%7C"+base_url)
		...
		$.get('https://raw.githubusercontent.com/abcotvdata/climate_risk_factors/main/data_tables/wind_zip_chart.csv', function(csvString) {
		    ...
		    filtered_data = data.filter(function(obj) {
          	...
          	if (filtered_data.length == 0) {
	          	...
	          	$(".wind-map-link").attr("href", "risk-maps.html?zip%7Cwind%7C"+picked_state_fips+"%7C"+picked_county_fips+"%7C"+picked_zip+"%7C"+base_url)
